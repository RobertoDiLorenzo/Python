...
# Iterate
denom = 2/hx2 + 2/hy2
tolerance = 1e10  # Tolleranza per la condizione di stop
max_iterations = 1000
fig = plt.figure(1)
...
# Iterate the solution
    ...
    if max_diff < tolerance:
        print(f"Converged after {n+1} iterations with max difference {max_diff:.2e}")
        break
else:
    print(f"Did not converge within {max_iterations} iterations. Max difference {max_diff:.2e}")
